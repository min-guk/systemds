...
public class FederatedLMPlanningTest extends AutomatedTestBase {
	private static final Log LOG = LogFactory.getLog(FederatedLMPlanningTest.class.getName());

	private final static String TEST_DIR = "functions/privacy/fedplanning/";
	private final static String TEST_NAME = "FederatedLMPlanningTest";
	private final static String TEST_NAME_2 = "FederatedLMFunctionPlanningTest";
	private final static String TEST_CLASS_DIR = TEST_DIR + FederatedLMPlanningTest.class.getSimpleName() + "/";
	...
	@Test
	public void runLMPlannerExactPrivacyPrivateAggregate(){
	...
	@Ignore("public privacy constraints ignored in this run")
	@Test
	public void runLMPlannerExactPrivacyPublic(){
	...
	@Ignore("public privacy constraints ignored in this run")
	@Test
	public void runLMFunctionPlannerExactPrivacyPublic(){
		runTestWithConfig("SystemDS-config-exact.xml", "public", TEST_NAME_2);
	}
