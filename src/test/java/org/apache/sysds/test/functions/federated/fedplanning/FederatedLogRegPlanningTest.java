...
public class FederatedLogRegPlanningTest extends AutomatedTestBase {
	private static final Log LOG = LogFactory.getLog(FederatedLogRegPlanningTest.class.getName());

	private final static String TEST_DIR = "functions/privacy/fedplanning/";
	private final static String TEST_NAME = "FederatedLogRegPlanningTest";
	private final static String TEST_CLASS_DIR = TEST_DIR + FederatedLogRegPlanningTest.class.getSimpleName() + "/";
	...
	@Test
	public void runLogRegPlannerExactPrivacyPrivateAggregate() {
	...
	@Ignore("public privacy constraints ignored in this run")
	@Test
	public void runLogRegPlannerExactPrivacyPublic() {
