...
public class FederatedFNNParamServPlanningTest extends AutomatedTestBase {
	private static final Log LOG = LogFactory.getLog(FederatedFNNParamServPlanningTest.class.getName());
