...
/** Docker L2SVM regression: every FedAll REFED source must own a lowerable local Lop. */
@net.jcip.annotations.NotThreadSafe
public class CampaignBG014FedAllL2SvmRefedSourceLoweringRedTest {
	@Test
	public void fedAllL2SvmTwoWorkersLowersEverySelectedRefedSource() throws Exception {
		...
		Thread worker1 = null;
		Thread worker2 = null;
		Path root = Files.createTempDirectory(Path.of("target"), "g014-fedall-l2svm-refed-");
		try {
			...
			Assert.assertTrue("FedAll L2SVM compile must lower every selected REFED source", success);
