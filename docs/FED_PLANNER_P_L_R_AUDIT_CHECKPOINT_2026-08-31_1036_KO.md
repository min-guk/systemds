...
**보고 시각:** 2026-08-31 10:36:44 CEST  
...
각 manifest row는 별도 Maven/Surefire JVM에서 실행된다. 10:36:44 CEST 진행률:

| Host | 완료 | SUCCESS | TNR | WPI | TRIAGE |
|---|---:|---:|---:|---:|---:|
| `so003` | 33/285 | 33 | 0 | 0 | 0 |
| `so004` | 24/268 | 20 | 0 | 1 | 3 |
| `so006` | 21/271 | 19 | 0 | 0 | 2 |
| **합계** | **78/824 (9.47%)** | **72** | **0** | **1** | **5** |
